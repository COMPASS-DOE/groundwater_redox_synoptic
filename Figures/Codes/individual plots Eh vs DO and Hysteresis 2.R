...
window_size <- 50
df_troll <- df_troll %>%
  mutate(smoothed_rdo_concen1 = rollmeanr(rdo_concen, k = window_size, fill = NA))

df_troll <- df_troll %>%
  mutate(smoothed_rdo_concen2 = rollmean(rdo_concen, k = window_size, align = "center", fill = NA))
