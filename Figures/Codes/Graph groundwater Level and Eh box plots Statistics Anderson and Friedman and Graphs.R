...
# paired per datetime
#Wilcoxon post hoc test for multiple comparisons
...
pwc2<-df_filtered%>%sign_test(wl_below_surface_m ~ site_location, p.adjust.method = "bonferroni")
print(pwc2, n=36)
...
# A tibble: 36 × 9
   .y.                group1  group2     n1    n2 statistic         p     p.adj p.adj.signif
 * <chr>              <chr>   <chr>   <int> <int>     <dbl>     <dbl>     <dbl> <chr>       
 1 wl_below_surface_m CRC-TR  CRC-UP   3227  3227   5208378 0         0         ****        
 2 wl_below_surface_m CRC-TR  CRC-W    3227  3227         0 0         0         ****        
 3 wl_below_surface_m CRC-TR  OWC-TR   3227  3227     68269 0         0         ****        
 4 wl_below_surface_m CRC-TR  OWC-W    3227  3227         2 0         0         ****        
 5 wl_below_surface_m CRC-TR  OWC-WTE  3227  3227   2368114 8.19e-  6 2.95e-  4 ***         
 6 wl_below_surface_m CRC-TR  PTR-TR   3227  3227   5208378 0         0         ****        
 7 wl_below_surface_m CRC-TR  PTR-UP   3227  3227   5208378 0         0         ****        
 8 wl_below_surface_m CRC-TR  PTR-W    3227  3227    888423 1.67e-230 6.01e-229 ****        
 9 wl_below_surface_m CRC-UP  CRC-W    3227  3227         0 0         0         ****        
10 wl_below_surface_m CRC-UP  OWC-TR   3227  3227         0 0         0         ****        
11 wl_below_surface_m CRC-UP  OWC-W    3227  3227         0 0         0         ****        
12 wl_below_surface_m CRC-UP  OWC-WTE  3227  3227         0 0         0         ****        
13 wl_below_surface_m CRC-UP  PTR-TR   3227  3227     17237 0         0         ****        
14 wl_below_surface_m CRC-UP  PTR-UP   3227  3227    194626 0         0         ****        
15 wl_below_surface_m CRC-UP  PTR-W    3227  3227         0 0         0         ****        
16 wl_below_surface_m CRC-W   OWC-TR   3227  3227   4865649 0         0         ****        
17 wl_below_surface_m CRC-W   OWC-W    3227  3227   1851206 6.34e- 46 2.28e- 44 ****        
18 wl_below_surface_m CRC-W   OWC-WTE  3227  3227   5155436 0         0         ****        
19 wl_below_surface_m CRC-W   PTR-TR   3227  3227   5208378 0         0         ****        
20 wl_below_surface_m CRC-W   PTR-UP   3227  3227   5208378 0         0         ****        
21 wl_below_surface_m CRC-W   PTR-W    3227  3227   5208378 0         0         ****        
22 wl_below_surface_m OWC-TR  OWC-W    3227  3227    204816 0         0         ****        
23 wl_below_surface_m OWC-TR  OWC-WTE  3227  3227   4950349 0         0         ****        
24 wl_below_surface_m OWC-TR  PTR-TR   3227  3227   5208378 0         0         ****        
25 wl_below_surface_m OWC-TR  PTR-UP   3227  3227   5208378 0         0         ****        
26 wl_below_surface_m OWC-TR  PTR-W    3227  3227   4865633 0         0         ****        
27 wl_below_surface_m OWC-W   OWC-WTE  3227  3227   5208378 0         0         ****        
28 wl_below_surface_m OWC-W   PTR-TR   3227  3227   5208378 0         0         ****        
29 wl_below_surface_m OWC-W   PTR-UP   3227  3227   5208378 0         0         ****        
30 wl_below_surface_m OWC-W   PTR-W    3227  3227   5208378 0         0         ****        
31 wl_below_surface_m OWC-WTE PTR-TR   3227  3227   5208378 0         0         ****        
32 wl_below_surface_m OWC-WTE PTR-UP   3227  3227   5208378 0         0         ****        
33 wl_below_surface_m OWC-WTE PTR-W    3227  3227   1691124 1.12e- 66 4.03e- 65 ****        
34 wl_below_surface_m PTR-TR  PTR-UP   3227  3227   5174252 0         0         ****        
35 wl_below_surface_m PTR-TR  PTR-W    3227  3227         0 0         0         ****        
36 wl_below_surface_m PTR-UP  PTR-W    3227  3227         0 0         0         ****        "
...
pplotf1 <- plotf1+theme(plot.margin = unit(c(0.1, 1, 0.1, 0.5), "cm"))
pplotf2 <- plotf2+theme(plot.margin = unit(c(0.1, 1, 0.1, 0.5), "cm"))

pp <- list(pplotf2, pplotf1)
#plot_grid(plotlist = pp, nrow = 3, ncol = 2, align = 'hv', axis = "tb", legend = ggplot2::"top")

# create a legend
legend <- get_legend(plotf1 + theme(legend.position = "bottom"))

# decrease the space of the legend
legend$heights[2] <- unit(0.1, "cm")

# add the legend to the bottom of the grid
grid.arrange(grobs = list(plot_grid(plotlist = pp, nrow = 2, ncol = 1, align = 'hv', axis = "tb"), 
...
df_troll %>% 
  ...
  theme(text = element_text(size = 16),
        axis.text.x = element_text(angle = 45, hjust = 1))->aa

ggsave("Eh_Seasonal.png", plot = aa, dpi = 300)
...
df_troll %>% 
  ...
  geom_boxplot()+
  facet_grid(site~location, scale="free")+
  labs(x="", y="Groundwater level (mV)")+
  ggtitle("A") +
  theme(text = element_text(size = 16),
        axis.text.x = element_text(angle = 45, hjust = 1))->ab

ggsave("GWL_Seasonal.png", plot = ab, dpi = 300)

plot_grid(ab, aa, nrow=2)->c
ggsave("GWL and Eh_Seasonal.png", plot = c, dpi = 300)
